...
public class GameManager {
    private static Map<String, Boolean> questStatuses = new HashMap<>();
    public static void playGame(Scanner scanner, Player player, MainMap mainMap, BattleMap battleMap, Settlement settlement) {
        ...
        System.out.println("=== DEBUG: Начало игры ===");
        System.out.println("Тип карты: " + (battleMap.useCustomMap ? "Кастомная" : "Стандартная"));
        System.out.println("Первый символ карты: " + battleMap.getBoard()[3][3]);
                ...
                switch (input.charAt(0)) {
                    ...
                    case 'M':
                        GameMenu menu = new GameMenu(
                                ...
                                player.getX(),
                                player.getY(),
                                questStatuses, // Map<String, Boolean>
                                scanner
                        );
                        menu.showMenu();
                        break;

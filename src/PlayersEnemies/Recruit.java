...
public class Recruit extends Entity implements Serializable {
    ...
    public Recruit deepCopy() {
        Recruit copy = new Recruit(this.name, this.health, this.damage, this.armor);
        // Копируем другие поля если есть
        return copy;
    }
